 ...
 * Invariante: Der Bruch ist immer gekuerzt. Der Nenner ist immer groesser als
 * 0.
 * 
...
public class Bruch {
	 ...
	 * 
	 * @throws ArithmeticException falls der Zaehler 0 war.
	 */
	public void inverse() {
	...
	public String toString() {
		return format == null ? new SchraegstrichFormat().bruchToString(zaehler, nenner)
				: format.bruchToString(zaehler, nenner);
	}
